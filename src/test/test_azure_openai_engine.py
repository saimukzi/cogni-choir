...
class TestAzureOpenAIEngine(unittest.TestCase):
    ...
    def setUp(self, MockAzureOpenAI):
        ...
        self.conversation_history_mixed = [
            ...
            {"role": self.role_name, "text": "First response from assistant."},
        ...
        self.expected_messages_mixed = [
            ...
            {"role": "user", "content": "Second message from another user."}
        ]
        ...
        # Ensure the mock was called correctly during engine initialization

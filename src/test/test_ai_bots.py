...
from src.main.ai_bots import Bot, AIEngine, GeminiEngine, GrokEngine, OpenAIEngine
...
class TestGeminiEngine(unittest.TestCase):
    ...
    @patch('src.main.ai_bots.genai') # Ensure genai is mocked even if not used directly in this path
    ...
    @patch('src.main.ai_bots.genai', None) 
...
class TestOpenAIEngine(unittest.TestCase):
    ...
    @patch('src.main.ai_bots.openai') # Ensure openai is mocked
    ...
    @patch('src.main.ai_bots.openai', None) 
...
class TestGrokEngine(unittest.TestCase): 
    ...
    @patch('src.main.ai_bots.genai') # Mock genai for base class init test consistency

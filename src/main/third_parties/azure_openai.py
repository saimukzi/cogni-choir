...
class AzureOpenAI(third_party.ThirdPartyBase):
    ...
    def _get_client(self, apikey: str, azure_endpoint: str, api_version: str) -> openai.AzureOpenAI:
        """Retrieves or creates an AzureOpenAI client.

        Manages a dictionary of client instances, keyed by a tuple of
        (apikey, azure_endpoint, api_version), to reuse clients if possible.

        Args:
            apikey (str): The Azure OpenAI API key.
        ...
        """
        client_key = (apikey, azure_endpoint, api_version)

...
class XAI(third_party.ThirdPartyBase):
    ...
    def generate_response(
        ...
        Args:
            ...
            apikeey_list (list[str]): List containing the xAI API key.
        ...
        assert (len(apikeey_list) == 1), "XAI requires exactly one API key."
    ...
    def _get_client(self, apikeey: str) -> openai.OpenAI:

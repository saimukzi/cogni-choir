...
try:
    ...
    from .ai_bots import Bot, GeminiEngine, GrokEngine, OpenAIEngine, AIEngine
    from .api_key_manager import ApiKeyManager
    from .message import Message # Added Message import
except ImportError:
    # Fallback for running script directly for testing
    from chatroom import Chatroom, ChatroomManager
    from ai_bots import Bot, GeminiEngine, GrokEngine, OpenAIEngine, AIEngine
    from api_key_manager import ApiKeyManager
    from message import Message # Added Message import for fallback

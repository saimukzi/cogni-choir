...
class Chatroom:
    ...
    def from_dict(data: dict, manager: ChatroomManager, filepath: str, api_key_manager) -> Chatroom:
        ...
        # if ChatroomManager also imports them for some reason (though not strictly needed here now)
        from .ai_bots import GeminiEngine, GrokEngine, OpenAIEngine, Bot # Ensure Bot is imported here
...
class ChatroomManager:
    ...
    def clone_chatroom(self, original_chatroom_name: str) -> Optional[Chatroom]:
        ...
        from .ai_bots import Bot, GeminiEngine, GrokEngine, OpenAIEngine 
